...
- **[07-12] Login Flow**: Especificación detallada del flujo de login con orquestador
...
| 1.1 | Ene 23, 2026 | Movido de `docs/03-business-flow/` a `docs/07-flows/` como `07-14-auth-flow-specification.md`. Actualizada referencia a 07-12-login-flow.md en Referencias. | Equipo de Desarrollo Goluti |

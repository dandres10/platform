...
if settings.has_track:
    CurrencyRepository.save = execute_transaction(LAYER.I_D_R.value)(
        CurrencyRepository.save
    )
    CurrencyRepository.update = execute_transaction(LAYER.I_D_R.value)(
        CurrencyRepository.update
    )
    CurrencyRepository.list = execute_transaction(LAYER.I_D_R.value)(
        CurrencyRepository.list
    )
    CurrencyRepository.delete = execute_transaction(LAYER.I_D_R.value)(
        CurrencyRepository.delete
    )
    CurrencyRepository.read = execute_transaction(LAYER.I_D_R.value)(
        CurrencyRepository.read
    )

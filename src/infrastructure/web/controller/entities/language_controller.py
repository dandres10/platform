...
class LanguageController:
    ...
    def save(self, config: Config, params: LanguageSave) -> Response:
        result_save = self.language_save_use_case.execute(config=config, params=params)
    ...
    def update(self, config: Config, params: LanguageUpdate) -> Response:
        result_update = self.language_update_use_case.execute(config=config, params=params)
    ...
    def list(self, config: Config, params: Pagination) -> Response:
        result_list = self.language_list_use_case.execute(config=config, params=params)
    ...
    def delete(self, config: Config, params: LanguageDelete) -> Response:
        result_delete = self.language_delete_use_case.execute(config=config, params=params)
    ...
    def read(self, config: Config, params: LanguageRead) -> Response:
        result_delete = self.language_read_use_case.execute(config=config, params=params)
        if isinstance(result_delete, str):
            return Response.error(None, result_delete)
        return Response.success_temporary_message(
            response=result_delete,

...
from src.domain.models.entities.password_reset_token.index import PasswordResetToken
from src.domain.services.repositories.entities.i_password_reset_token_repository import (
    IPasswordResetTokenRepository,
)


class PasswordResetTokenListUseCase:
    def __init__(self, password_reset_token_repository: IPasswordResetTokenRepository):
    ...
    async def execute(
        ...
        config: Config,
        params: Pagination,
    ) -> Union[List[PasswordResetToken], str, None]:
        results = await self.password_reset_token_repository.list(

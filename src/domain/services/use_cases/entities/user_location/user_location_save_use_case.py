...
from src.domain.models.entities.user_location.index import UserLocation, UserLocationSave
...
from src.infrastructure.database.mappers.user_location_mapper import (
    map_to_save_user_location_entity,
)
from src.core.classes.message import Message
from src.core.enums.keys_message import KEYS_MESSAGES
from src.core.models.message import MessageCoreEntity

class UserLocationSaveUseCase:
    ...
    def execute(
        self,
        config: Config,
        params: UserLocationSave,
    ) -> Union[UserLocation, str, None]:
        result = map_to_save_user_location_entity(params)
        result = self.user_location_repository.save(config=config, params=result)
        if not result:

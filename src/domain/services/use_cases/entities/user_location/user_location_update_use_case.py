...
from src.domain.models.entities.user_location.index import UserLocation, UserLocationUpdate
...
class UserLocationUpdateUseCase:
    ...
    def execute(
        ...
        result = self.user_location_repository.update(config=config, params=params)
        if not result:

...
from src.domain.models.entities.user_location.index import UserLocation, UserLocationRead
...
class UserLocationReadUseCase:
    ...
    def execute(
        ...
        result = self.user_location_repository.read(config=config, params=params)
        if not result:

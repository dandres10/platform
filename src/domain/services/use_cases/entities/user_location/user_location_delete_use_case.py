...
from src.domain.models.entities.user_location.index import UserLocationDelete, UserLocation
...
class UserLocationDeleteUseCase:
    ...
    def execute(
        ...
        result = self.user_location_repository.delete(config=config, params=params)
        if not result:
